    ...
    <>
      <div className={`${receiptData ? "print:hidden" : ""} min-h-screen w-full`}>
        <Routes>
          ...
          {/* ✅ الوحدات والإضافات ضمن المنتجات */}
          <Route
            path="/products/units"
            element={
              <Layout>
          ...
          />
          <Route
            path="/settings/group-permissions/:id"
            element={
              <Layout>
                <GroupPermissions />
              </Layout>
          ...
          />
          <Route
            path="/settings/payment-companies"
            element={
              <Layout>
                <PaymentCompanies />
              </Layout>
          ...
          />
          <Route
            path="/settings/basic-categories"
            element={
              <Layout>
                <Categories />
              </Layout>
          ...
          />
          <Route
            path="/settings/delivery-companies"
            element={
              <Layout>
                <DeliveryCompanies />
              </Layout>
          ...
          />
          <Route
            path="/reports/quantity-adjustments"
            element={
              <Layout>
                <QuantityAdjustmentsReport />
              </Layout>
            }
          />
          <Route
            path="/reports/machine-adjustments"
            element={
              <Layout>
                <MachineQuantityAdjustments />
              </Layout>
            }
          />
          <Route
          ...
          />
          <Route
            path="/reports/summary-movements"
            element={
              <Layout>
                <SummaryMovementsReport />
              </Layout>
            }
          />
          <Route
          ...
          />
          <Route
            path="/reports/detailed-daily-sales"
            element={
              <Layout>
                <DetailedDailySalesReport />
              </Layout>
            }
          />
          <Route
            path="/reports/cashier-sales-summary"
            element={
              <Layout>
                <CashierSalesSummaryReport />
              </Layout>
            }
          />
          <Route
            path="/reports/sales-by-item-invoice"
            element={
              <Layout>
                <SalesByItemInvoiceReport />
              </Layout>
            }
          />
          <Route
            path="/reports/reps-sales"
            element={
              <Layout>
                <RepsSalesReport />
              </Layout>
          ...
          />
          <Route
            path="/reports/influencer-percents"
            element={
              <Layout>
                <InfluencerPercentsReport />
              </Layout>
            }
          />
          <Route
